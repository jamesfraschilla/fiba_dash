...
export function analysisPeriodLengthMinutes(period) {
  return safeNumber(period, 0) > 4 ? OVERTIME_PERIOD_MINUTES : REGULATION_PERIOD_MINUTES;
}
...
const ANALYSIS_SEGMENT_PRESETS = [
  { value: "all", label: "All Segments", minPeriod: 1, minMinutes: REGULATION_PERIOD_MINUTES, minSeconds: 0, maxPeriod: 4, maxMinutes: 0, maxSeconds: 0 },
  { value: "q1", label: "Q1", minPeriod: 1, minMinutes: REGULATION_PERIOD_MINUTES, minSeconds: 0, maxPeriod: 1, maxMinutes: 0, maxSeconds: 0 },
  { value: "q2", label: "Q2", minPeriod: 2, minMinutes: REGULATION_PERIOD_MINUTES, minSeconds: 0, maxPeriod: 2, maxMinutes: 0, maxSeconds: 0 },
  { value: "q3", label: "Q3", minPeriod: 3, minMinutes: REGULATION_PERIOD_MINUTES, minSeconds: 0, maxPeriod: 3, maxMinutes: 0, maxSeconds: 0 },
  { value: "q1-q3", label: "Q1-Q3", minPeriod: 1, minMinutes: REGULATION_PERIOD_MINUTES, minSeconds: 0, maxPeriod: 3, maxMinutes: 0, maxSeconds: 0 },
  { value: "q4", label: "Q4", minPeriod: 4, minMinutes: REGULATION_PERIOD_MINUTES, minSeconds: 0, maxPeriod: 4, maxMinutes: 0, maxSeconds: 0 },
  { value: "first-half", label: "1st Half", minPeriod: 1, minMinutes: REGULATION_PERIOD_MINUTES, minSeconds: 0, maxPeriod: 2, maxMinutes: 0, maxSeconds: 0 },
  { value: "second-half", label: "2nd Half", minPeriod: 3, minMinutes: REGULATION_PERIOD_MINUTES, minSeconds: 0, maxPeriod: 4, maxMinutes: 0, maxSeconds: 0 },
];
