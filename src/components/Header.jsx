...
export default function Header({ theme, onToggleTheme, onSignOut, profile, isAdmin, canUseTools }) {
  ...
  const competitionParam = params.get("competition") || undefined;
  ...
  const { data: games = [] } = useQuery({
    queryKey: ["headerGames", dateInput, competitionParam || "", seasonParam || ""],
    queryFn: () => fetchGamesByDate(dateInput, { competitionId: competitionParam, seasonId: seasonParam }),
